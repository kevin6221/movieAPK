...
class TopRatedModel {
  ...
  factory TopRatedModel.fromJson(Map<String, dynamic> json) => TopRatedModel(
    page: json["page"],
    results: List<TopRatedDatum>.from(json["results"].map((x) => TopRatedDatum.fromJson(x))),
...
class TopRatedDatum {
  ...
  factory TopRatedDatum.fromJson(Map<String, dynamic> json) => TopRatedDatum(
    adult: json["adult"],
