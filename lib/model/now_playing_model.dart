...
class NowPlayingModel {
  ...
  factory NowPlayingModel.fromJson(Map<String, dynamic> json) => NowPlayingModel(
    ...
    page: json["page"],
    results: List<NowPlayingDatum>.from(json["results"].map((x) => NowPlayingDatum.fromJson(x))),
...
class NowPlayingDatum {
  ...
  factory NowPlayingDatum.fromJson(Map<String, dynamic> json) => NowPlayingDatum(
    adult: json["adult"],
